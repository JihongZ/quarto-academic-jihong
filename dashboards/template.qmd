...
DT::datatable(SessionInfo, style = 'bootstrap4') |> 
  DT::formatStyle(columns = c("Session"), fontWeight = 'bold', `text-align` = 'left') |> 
  DT::formatStyle(columns = c("Presentation"), color = "#293352", `text-align` = 'left')
```
