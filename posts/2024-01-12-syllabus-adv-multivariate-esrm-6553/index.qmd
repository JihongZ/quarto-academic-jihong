---
title: "ESRM 6553: Adv. Multivariate"
...
2.  **Bayesian Inference and Computational Methods**
    -   Markov Chain Monte Carlo (MCMC) estimation procedures;
3.  **Bayesian Modeling Evaluation**
...
5.  **Advanced Topics in Bayesian Multivariate Analysis**
    -   Bayesian networks.
...
| 1        | 01/15    | No Class                                             |                                                                                              |                                                                        |                                                                       |
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
| 2        | 01/22    | Introduction to Bayesian Statistics Part I           | SR[^1] Chapter 1; BDA[^2] Chapter 1 (Optional)                                               | [Lecture01_Jan22](./Lecture01/Lecture01.qmd)                           |                                                                       |
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
| 3        | 01/29    | Introduction to Bayesian Statistics Part II          | SR Chapter 2                                                                                 | [Lecture02_Jan29](./Lecture02/Lecture02.qmd)                           |                                                                       |
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
| 4        | 02/05    | Bayesian Inference and Computational Methods I       | SR Chapter 9                                                                                 | [Lecture03_Feb05](./Lecture03/Lecture03.qmd)                           | 1.  [DietGroup.csv](./Lecture03/Code/DietData.csv)                    |
...
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
| 5        | 02/12    | Bayesian Inference and Computational Methods II      | [StanUserGuide:Chapter21](https://mc-stan.org/docs/2_18/stan-users-guide/vectorization.html) | 1.  [Lecture04_Feb12: Vectorization of Stan](Lecture04/Lecture04.qmd)  | 1.  [DietDataExample2.R](Lecture04/Code/DietDataExample2.R)           |
|          |          |                                                      |                                                                                              | 2.  [Lecture04:recording.mp4](Lecture04/Lecture04_Feb12_recording.mp4) | 2.  [FullModel_Old.stan](Lecture04/Code/FullModel_Old.stan)           |
|          |          |                                                      |                                                                                              |                                                                        | 3.  [FullModel_New.stan](Lecture04/Code/FullModel_New.stan)           |
...
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
| 6        | 02/19    | Bayesian Inference and Computational Methods III     | SR Chapter 9.2 & 9.3                                                                         |                                                                        |                                                                       |
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
| 7        | 02/26    | Bayesian Modeling Evaluation I: Model diagnosis      | SR Chapter 7.1 & BPM[^3] Chapter 10                                                          |                                                                        |                                                                       |
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+------------------------------------------------------------------------+-----------------------------------------------------------------------+
...
: {.striped .hover .bordered .responsive-xl tbl-colwidths="\[5,5,30,20,17,23\]"}
