...
-   **Supplementary Texts:** [Stan User's Guide](https://mc-stan.org/docs/2_33/stan-users-guide-2_33.pdf)

## Software

-   R and R packages (tidyverse)
-   Stan is gaining in popularity and has an avid user community. To use Stan in R, you need to download RStan package. Here is the [tutorial](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started) of installing RStan.
...
+----------+----------+------------------------------------------------------+------------------------------------------------+----------------------------------------------+---------------------------------------------------------+
| 4        | 02/05    | Bayesian Inference and Computational Methods I       | SR Chapter 9                                   | [Lecture03_Feb05](./Lecture03/Lecture03.qmd) | [DietGroup.csv](./Lecture03/Code/DietData.csv)          |
|          |          |                                                      |                                                |                                              |                                                         |
|          |          |                                                      |                                                |                                              | [DietDataExample.R](./Lecture03/Code/DietDataExample.R) |
+----------+----------+------------------------------------------------------+------------------------------------------------+----------------------------------------------+---------------------------------------------------------+
| 5        | 02/12    | Bayesian Inference and Computational Methods II      | SR Chapter 3                                   |                                              |                                                         |
+----------+----------+------------------------------------------------------+------------------------------------------------+----------------------------------------------+---------------------------------------------------------+
...
: {.striped .hover .bordered .responsive-xl tbl-colwidths="\[5,5,30,20,20,20\]"}
