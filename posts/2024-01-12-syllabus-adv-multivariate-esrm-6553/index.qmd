...
+----------+----------+------------------------------------------------------+----------------------------------------------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------------------------------------+
| 5        | 02/12    | Bayesian Inference and Computational Methods II      | [StanUserGuide:Chapter21](https://mc-stan.org/docs/2_18/stan-users-guide/vectorization.html) | [Lecture04_Feb12: Vectorization of Stan](Lecture04/Lecture04.qmd) | 1.  [DietDataExample2.R](Lecture04/Code/DietDataExample2.R)           |
