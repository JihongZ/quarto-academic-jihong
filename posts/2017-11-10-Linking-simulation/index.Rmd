...
root_dir = "/Users/jihong/Documents/Projects/quarto-academic-jihong/posts/2017-11-10-Linking-simulation/"
...
Using 3-PL for irt model of form A. Extracting the cofficients (a, b, c) of IRT. The model-implied theta was outputed, whose mean is `r mean(theta_A)`
...
\theta_{A} = \theta_{B} - 0.25 \\
\sigma_A^2 = \sigma_B^2
$$ thus, $b_B -b_A$ should also be -0.25. the estimated difference of b is calculate by the mean of b parametes of Form A's common items and that of Form B's common items, which is `r mean(b_B[51:60])-mean(b_A[51:60])`. Thus, it is very close to difference of true traits.
